...
function createImg(movieData){
    let img = document.createElement("img");
    img.setAttribute("src" , `img/posters/${movieData.poster}`);
    img.setAttribute("class" , "moviePoster");
    img.setAttribute("alt" , `${movieData.title}`);
    return img;
}
function createContent(movie){
    ...
    h1.setAttribute("class" , "h1large");
    h1.textContent = movie.title;

    let img = document.createElement("img");
    img.setAttribute("src", "img/imdb.png")
    img.setAttribute("class" , "imdbLarge");
    ...
    video.setAttribute("src" , `https://www.youtube.com/embed/${movie.trailer}`);
...
function initialize(title){
    ...
    let img = createImg(movieData);
    let div = createContent(movieData);
